...
function Home() {
	return (
		<div className="bg-white h-screen w-full pt-10  flex flex-col justify-normal gap-10 ">
			<header className="flex justify-between items-center pl-6 pr-4">
			...
			<div className="h-screen w-full flex flex-col justify-normal items-center">
				...
				<div className="flex justify-between w-96 pt-6">
					<div>
						<span className="text-black text-xl font-medium font-jacques">
							Veg Only
						</span>
